...
│     ├─ 20251022120000_general_information_table.sql
│     └─ upload-files.sql
├─ tailwind.config.ts
├─ tsconfig.app.json
├─ tsconfig.json
...
│     ├─ 20251006082912_b5357026-1df6-4f4b-bd54-966390dace90.sql
│     ├─ 20251022120000_general_information_table.sql
│     ├─ 20251109_uploaded_files.sql
│     ├─ 20251110063701_marital_status.sql
│     └─ 251110064302_children_information.sql
├─ tailwind.config.ts
├─ tmp_delete_mutation_patch.txt
├─ tsconfig.app.json
├─ tsconfig.json
└─ tsconfig.node.json
